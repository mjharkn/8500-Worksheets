...
> The comma at the end of the range given specifies that it is asking for an output of rows, whereas the previous line of code doesn't specify so it gives the columns and rows (?)
...
> This code specifies that we are looking for the city in columns 100 through 110.
...
if (presidents > 5) print(TRUE) else print("This list is less than 5")
```
