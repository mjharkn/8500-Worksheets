...
> I know how to arrange the X1850 column and can see when I view the dataframe that the answer is New York had the largest population in 1850, but I am stuck on how to connect this to the state column.
...
> So right now, I can figure out how to get a count of how many locations were in a city in a specific year, but I need to figure out how to get it to combine the years. I am thinking that count isn't the right thing to use in summarize maybe?? I will come back to this.
...
> Stuck here for now; how do I get it to calculate the growth? Do I use something within the summarize function or do I use mutate and use the difference to calculate the growth and then create a dataframe based on that difference??
