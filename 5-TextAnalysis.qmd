...
```{r}
# read documentation then do, also you cannot tokenize a dataset you already tokenized, you have to use the full dataset :3
```
...
> Not all of them are speeches not addresses
